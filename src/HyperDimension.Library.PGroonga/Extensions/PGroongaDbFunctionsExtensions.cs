...
public static class PGroongaDbFunctionsExtensions
{
        /// <summary>
    ...
    /// <returns>The result as text type value</returns>
    /// <remarks>https://pgroonga.github.io/reference/functions/pgroonga-command.html</remarks>
    public static string PGroongaCommand(this DbFunctions _, string command, string[] arguments) =>
    ...
    public static string PGroongaCommandEscapeValue(this DbFunctions _, string value) =>
        throw new NotSupportedException();
    ...
    /// <returns>Script syntax safely literal</returns>
    /// <remarks>https://pgroonga.github.io/reference/functions/pgroonga-escape.html</remarks>
    public static string PGroongaEscape(this DbFunctions _, string value, string[] specialCharacters) =>
        throw new NotSupportedException();
    ...
    public static string PGroongaHighlightHtml(this DbFunctions _, string target, string[] keywords) =>
        throw new NotSupportedException();
    ...
    /// <remarks>https://pgroonga.github.io/reference/functions/pgroonga-highlight-html.html</remarks>
    public static string PGroongaHighlightHtml(this DbFunctions _, string target, string[] keywords,
        string pgroongaIndexName) => throw new NotSupportedException();
...
#pragma warning disable CA1814
    public static int[,] PGroongaMatchPositionsByte(this DbFunctions _, string target, string[] keywords) =>
        throw new NotSupportedException();
...
#pragma warning disable CA1814
    public static int[,] PGroongaMatchPositionsCharacter(this DbFunctions _, string target, string[] keywords) =>
        throw new NotSupportedException();
#pragma warning restore CA1814

    /// <summary>
    /// Converts a text into a normalized form using normalizer modules from Groonga
    /// </summary>
    /// <param name="_"><see cref="DbFunctions"/></param>
    /// <param name="target">A text to be highlighted</param>
    ...
    /// <returns>Normalized text</returns>
    /// <remarks>https://pgroonga.github.io/reference/functions/pgroonga-normalize.html</remarks>
    public static string PGroongaNormalize(this DbFunctions _, string target, string normalizerName) =>
        throw new NotSupportedException();
    ...
    public static string PGroongaQueryExpand(this DbFunctions _, string tableName, string termColumnName,
        string synonymsColumnName, string query) => throw new NotSupportedException();
    ...
    public static string[] PGroongaQueryExtractKeywords(this DbFunctions _, string query) =>
        throw new NotSupportedException();
    ...
    public static double PGroongaScore(this DbFunctions _) => throw new NotSupportedException();

    /// <summary>
    /// Get keyword in context in the specified text
    /// </summary>
    /// <param name="_"><see cref="DbFunctions"/></param>
    /// <param name="target">A text to be searched</param>
    ...
    public static string[] PGroongaSnippetHtml(this DbFunctions _, string target, string[] keywords) =>
        throw new NotSupportedException();
    ...
    public static string PGroongaTableName(this DbFunctions _, string pgroongaIndexName) =>
        throw new NotSupportedException();
    ...
    /// <returns>The number of applied operations</returns>
    /// <remarks>https://pgroonga.github.io/reference/functions/pgroonga-wal-apply.html</remarks>
    public static long PGroongaWalApply(this DbFunctions _, string pgroongaIndexName) =>
        throw new NotSupportedException();
    ...
    /// <returns>The number of truncated PostgreSQL data blocks</returns>
    /// <remarks>https://pgroonga.github.io/reference/functions/pgroonga-wal-truncate.html</remarks>
    public static long PGroongaWalTruncate(this DbFunctions _, string pgroongaIndexName) =>
        throw new NotSupportedException();
}
